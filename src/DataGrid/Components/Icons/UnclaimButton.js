...
const UnclaimButton = (props) => {
    ...
    return <div className="h-100 py-1 me-3" onClick={() => { handleOnClick(ClaimConstants.UNCLAIM) }}>
        <Button variant="link" size="sm" className="h-100 text-danger">
            ...
            Unclaim  ({selectedRecords})</Button>
    </div>
}
